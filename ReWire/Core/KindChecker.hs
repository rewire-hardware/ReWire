...
redecorate s (RWCData l i tvs _ dcs) = do cas <- askCAssumps
                                          case Map.lookup i cas of
                                            Just k  -> return (RWCData l i tvs (monoize (subst s k)) dcs)
