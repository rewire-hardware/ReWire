...
* [ReWirePrelude.hs]({{ site.baseurl }}/assets/code/ReWirePrelude.hs): some standard definitions.
* [CrossbarSwitch.hs]({{ site.baseurl }}/assets/code/CrossbarSwitch.hs): a Haskell specification of a crossbar switch.
* [RWCrossbar.hs]({{ site.baseurl }}/assets/code/RWCrossbar.hs): the ReWire specification of a crossbar switch.
* [RWC.vhd]({{ site.baseurl }}/assets/code/RWC.vhd): the VHDL code generated by the ReWire compiler.
