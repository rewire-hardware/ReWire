module top_level (input logic [0:0] clk,
  ...
  assign zi7 = zi6[16:9];
  assign zi8 = zi6[8:1];
  ZLL_Main_incr32  inst ({zi7, zi7, zi8}, zll_main_incr32_out);
  assign zi9 = zll_main_incr32_out;
  assign zi10 = zi9[23:16];
  assign zi11 = zi9[15:8];
  assign zi12 = zi9[7:0];
  ZLL_Main_incr32  instR1 ({zi12, zi11, zi12}, zll_main_incr32_outR1);
  assign zi13 = zll_main_incr32_outR1;
  assign zi14 = {zi10, zi13};
  assign zi15 = zi14[33:26];
  assign zi16 = zi14[23:16];
  assign zi17 = zi14[15:8];
  assign zi18 = zi14[7:0];
  ZLL_Main_incr36  instR2 ({zi16, zi18}, zll_main_incr36_out);
  assign zi19 = zll_main_incr36_out;
  assign zi20 = {zi15, zi16, zi19};
  assign zi21 = zi20[41:34];
  assign zi22 = zi20[33:26];
  assign zi23 = zi20[15:8];
  assign zi24 = zi20[7:0];
  ZLL_Main_incr36  instR3 ({zi23, zi21 + zi22}, zll_main_incr36_outR1);
  assign zi25 = zll_main_incr36_outR1;
...
module Main_sig (input logic [7:0] arg0,
  ...
  logic [7:0] zi6;
  logic [7:0] zi7;
  assign zi0 = {arg0, arg0, arg1};
  assign zi1 = zi0[23:16];
  assign zi2 = zi0[15:8];
  assign zi3 = zi0[7:0];
  assign zi4 = {2'h0, zi1, zi2, zi3};
  assign zi5 = zi4[23:16];
  assign zi6 = zi4[15:8];
  assign zi7 = zi4[7:0];
  assign res = {2'h2, zi5, zi6, zi7};
endmodule