module top_level (input logic [0:0] clk,
  ...
  logic [0:0] zi29;
  logic [0:0] zi30;
  logic [4:0] zll_main_sig50_out;
  logic [0:0] rewire_prelude_not_outR1;
  logic [2:0] zi31;
  logic [0:0] zi32;
  logic [0:0] zi33;
  logic [4:0] zll_main_sig50_outR1;
  logic [4:0] zres;
  ReWire_Prelude_not  inst (__in0, rewire_prelude_not_out);
  assign zi3 = {__st0, __st1, rewire_prelude_not_out};
  assign zi4 = zi3[2];
  assign zi5 = zi3[1];
  ZLL_Main_sig48  instR1 ({zi4, zi4, zi5}, zll_main_sig48_out);
  assign zi6 = zll_main_sig48_out;
  assign zi7 = zi6[2];
  assign zi9 = zi6[0];
  assign zi27 = zi7 ^ zi9;
  ...
  assign zi29 = zi28[1];
  assign zi30 = zi28[0];
  ZLL_Main_sig50  instR2 ({3'h2, zi29, zi30}, zll_main_sig50_out);
  ReWire_Prelude_not  instR3 (__in0, rewire_prelude_not_outR1);
  assign zi31 = {__st0, __st1, rewire_prelude_not_outR1};
  assign zi32 = zi31[2];
  assign zi33 = zi31[1];
  ZLL_Main_sig50  instR4 ({3'h2, zi32, zi33}, zll_main_sig50_outR1);
  assign zres = (zi3[0] == 1'h1) ? zll_main_sig50_out : zll_main_sig50_outR1;
...
module ZLL_Main_sig50 (input logic [4:0] arg0,
  ...
  assign zi0 = arg0[1];
  assign zi1 = arg0[0];
  ZLL_Main_sig48  inst ({zi0, zi0, zi1}, zll_main_sig48_out);
  assign zi2 = zll_main_sig48_out;
  assign zi3 = zi2[2];
  assign zi4 = zi2[1];
  assign zi5 = zi2[0];
...
module ZLL_Main_sig48 (input logic [2:0] arg0,
  output logic [4:0] res);
  logic [0:0] zi0;
  logic [0:0] zi1;
  logic [0:0] zi2;
