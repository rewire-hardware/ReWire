module top_level (input logic [0:0] clk,
  ...
  logic [69:0] zll_main_reset44_out;
  logic [142:0] zll_main_loop226_outR2;
  logic [142:0] zi6;
  logic [69:0] zi7;
  logic [84:0] main_getout_out;
  logic [142:0] zll_main_loop142_out;
  logic [142:0] zi8;
  logic [14:0] zi9;
  logic [69:0] zi10;
  ...
  logic [7:0] zi20;
  logic [69:0] zi21;
  logic [69:0] zll_main_putreg11_out;
  logic [142:0] zll_main_loop226_outR4;
  logic [142:0] zll_main_loop202_out;
  ...
  logic [69:0] zll_main_reset44_outR1;
  logic [142:0] zll_main_loop226_outR7;
  logic [142:0] zi27;
  logic [69:0] zi28;
  logic [84:0] main_getout_outR1;
  logic [142:0] zll_main_loop142_outR1;
  logic [142:0] zi29;
  logic [14:0] zi30;
  logic [69:0] zi31;
  ...
  logic [69:0] zll_main_reset44_outR2;
  logic [142:0] zll_main_loop226_outR9;
  logic [142:0] zi35;
  logic [69:0] zi36;
  logic [84:0] main_getout_outR2;
  logic [142:0] zll_main_loop142_outR2;
  logic [142:0] zi37;
  logic [14:0] zi38;
  logic [69:0] zi39;
  logic [142:0] zres;
  Main_putIns  inst (__in0, __st0, main_putins_out);
  ZLL_Main_loop226  instR1 (main_putins_out, zll_main_loop226_out);
  assign zi2 = zll_main_loop226_out;
  assign zi3 = zi2[69:0];
  Main_incrPC  instR2 (zi3, main_incrpc_out);
  ZLL_Main_loop226  instR3 (main_incrpc_out, zll_main_loop226_outR1);
  assign zi4 = zll_main_loop226_outR1;
  assign zi5 = zi4[69:0];
  Main_getPC  instR4 (zi5, main_getpc_out);
  ZLL_Main_reset44  instR5 (main_getpc_out, zll_main_reset44_out);
  ZLL_Main_loop226  instR6 (zll_main_reset44_out, zll_main_loop226_outR2);
  assign zi6 = zll_main_loop226_outR2;
  assign zi7 = zi6[69:0];
  Main_getOut  instR7 (zi7, main_getout_out);
  ZLL_Main_loop142  instR8 (main_getout_out, zll_main_loop142_out);
  assign zi8 = zll_main_loop142_out;
  assign zi9 = zi8[84:70];
  assign zi10 = zi8[69:0];
  ZLL_Pure_dispatch8  instR9 (__in0, __st0, zll_pure_dispatch8_out);
  ZLL_Pure_dispatch8  instR10 (__in0, __st0, zll_pure_dispatch8_outR1);
  ZLL_Pure_dispatch8  instR11 (__in0, __st0, zll_pure_dispatch8_outR2);
  ZLL_Pure_dispatch8  instR12 (__in0, __st0, zll_pure_dispatch8_outR3);
  Main_putIns  instR13 (__in0, __st0, main_putins_outR1);
  ZLL_Main_loop226  instR14 (main_putins_outR1, zll_main_loop226_outR3);
  assign zi12 = zll_main_loop226_outR3;
  assign zi13 = zi12[69:0];
  Main_getIns  instR15 (zi13, main_getins_out);
  ...
  ZLL_Main_putReg11  instR16 (zi20, 2'h0, {2'h0, zi20}, zi21, zll_main_putreg11_out);
  ZLL_Main_loop226  instR17 (zll_main_putreg11_out, zll_main_loop226_outR4);
  ZLL_Main_loop202  instR18 (zll_main_loop226_outR4, zll_main_loop202_out);
  ZLL_Pure_dispatch8  instR19 (__in0, __st0, zll_pure_dispatch8_outR4);
  Main_putIns  instR20 (__in0, __st0, main_putins_outR2);
  ZLL_Main_loop226  instR21 (main_putins_outR2, zll_main_loop226_outR5);
  assign zi23 = zll_main_loop226_outR5;
  assign zi24 = zi23[69:0];
  Main_incrPC  instR22 (zi24, main_incrpc_outR1);
  ZLL_Main_loop226  instR23 (main_incrpc_outR1, zll_main_loop226_outR6);
  assign zi25 = zll_main_loop226_outR6;
  assign zi26 = zi25[69:0];
  Main_getPC  instR24 (zi26, main_getpc_outR1);
  ZLL_Main_reset44  instR25 (main_getpc_outR1, zll_main_reset44_outR1);
  ZLL_Main_loop226  instR26 (zll_main_reset44_outR1, zll_main_loop226_outR7);
  assign zi27 = zll_main_loop226_outR7;
  assign zi28 = zi27[69:0];
  Main_getOut  instR27 (zi28, main_getout_outR1);
  ZLL_Main_loop142  instR28 (main_getout_outR1, zll_main_loop142_outR1);
  assign zi29 = zll_main_loop142_outR1;
  assign zi30 = zi29[84:70];
  assign zi31 = zi29[69:0];
  Main_putIns  instR29 (__in0, __st0, main_putins_outR3);
  ZLL_Main_loop226  instR30 (main_putins_outR3, zll_main_loop226_outR8);
  assign zi33 = zll_main_loop226_outR8;
  assign zi34 = zi33[69:0];
  Main_getPC  instR31 (zi34, main_getpc_outR2);
  ZLL_Main_reset44  instR32 (main_getpc_outR2, zll_main_reset44_outR2);
  ZLL_Main_loop226  instR33 (zll_main_reset44_outR2, zll_main_loop226_outR9);
  assign zi35 = zll_main_loop226_outR9;
  assign zi36 = zi35[69:0];
  Main_getOut  instR34 (zi36, main_getout_outR2);
  ZLL_Main_loop142  instR35 (main_getout_outR2, zll_main_loop142_outR2);
  assign zi37 = zll_main_loop142_outR2;
  assign zi38 = zi37[84:70];
  assign zi39 = zi37[69:0];
  assign zres = (__resumption_tag == 4'h1) ? {{1'h1, {6'h35{1'h0}}}, zi9, 4'h7, zi10} : ((__resumption_tag == 4'h2) ? zll_pure_dispatch8_out : ((__resumption_tag == 4'h3) ? zll_pure_dispatch8_outR1 : ((__resumption_tag == 4'h4) ? zll_pure_dispatch8_outR2 : ((__resumption_tag == 4'h5) ? zll_pure_dispatch8_outR3 : ((__resumption_tag == 4'h6) ? zll_main_loop202_out : ((__resumption_tag == 4'h7) ? zll_pure_dispatch8_outR4 : ((__resumption_tag == 4'h8) ? {{1'h1, {6'h35{1'h0}}}, zi30, 4'h6, zi31} : {{1'h1, {6'h35{1'h0}}}, zi38, 4'h3, zi39})))))));
...
module ZLL_Pure_dispatch8 (input logic [16:0] arg0,
  ...
  ZLL_Main_loop226  instR1 (main_putins_out, zll_main_loop226_out);
  ZLL_Main_loop202  instR2 (zll_main_loop226_out, zll_main_loop202_out);
  assign res = zll_main_loop202_out;
endmodule

module ZLL_Main_reset44 (input logic [75:0] arg0,
  output logic [69:0] res);
  logic [5:0] zi0;
  logic [69:0] zi1;
  logic [69:0] main_putaddrout_out;
  logic [69:0] zll_main_loop143_out;
  assign zi0 = arg0[75:70];
  assign zi1 = arg0[69:0];
  Main_putAddrOut  inst (zi0, zi1, main_putaddrout_out);
  ZLL_Main_loop143  instR1 (main_putaddrout_out, zll_main_loop143_out);
  assign res = zll_main_loop143_out;
endmodule
...
module ZLL_Main_loop202 (input logic [142:0] arg0,
  output logic [142:0] res);
  logic [69:0] zi0;
  logic [86:0] main_getins_out;
  logic [86:0] zi1;
  ...
  logic [142:0] zll_main_loop142_outR3;
  logic [142:0] zi63;
  logic [14:0] zi64;
  logic [69:0] zi65;
  logic [5:0] zi66;
  ...
  logic [142:0] zll_main_loop142_outR4;
  logic [142:0] zi76;
  logic [14:0] zi77;
  logic [69:0] zi78;
  ...
  ZLL_Main_loop226  instR2 (main_incrpc_out, zll_main_loop226_out);
  assign zi18 = zll_main_loop226_out;
  assign zi19 = zi18[69:0];
  Main_getPC  instR3 (zi19, main_getpc_out);
  ZLL_Main_reset44  instR4 (main_getpc_out, zll_main_reset44_out);
  ZLL_Main_loop226  instR5 (zll_main_reset44_out, zll_main_loop226_outR1);
  assign zi20 = zll_main_loop226_outR1;
  assign zi21 = zi20[69:0];
  Main_getOut  instR6 (zi21, main_getout_out);
  ZLL_Main_loop142  instR7 (main_getout_out, zll_main_loop142_out);
  assign zi22 = zll_main_loop142_out;
  assign zi23 = zi22[84:70];
  assign zi24 = zi22[69:0];
  assign zi25 = zi9[75:70];
  Main_putAddrOut  instR8 (zi25, zi11, main_putaddrout_out);
  ZLL_Main_loop143  instR9 (main_putaddrout_out, zll_main_loop143_out);
  ZLL_Main_loop226  instR10 (zll_main_loop143_out, zll_main_loop226_outR2);
  assign zi26 = zll_main_loop226_outR2;
  assign zi27 = zi26[69:0];
  Main_getOut  instR11 (zi27, main_getout_outR1);
  ZLL_Main_loop142  instR12 (main_getout_outR1, zll_main_loop142_outR1);
  assign zi28 = zll_main_loop142_outR1;
  ...
  ZLL_Main_putWeOut5  instR17 (1'h1, zi42, zll_main_putweout5_out);
  ZLL_Main_loop226  instR18 (zll_main_putweout5_out, zll_main_loop226_outR3);
  assign zi43 = zll_main_loop226_outR3;
  assign zi44 = zi43[69:0];
  Main_getOut  instR19 (zi44, main_getout_outR3);
  ZLL_Main_loop142  instR20 (main_getout_outR3, zll_main_loop142_outR2);
  assign zi45 = zll_main_loop142_outR2;
  ...
  ZLL_Main_putReg11  instR23 (zi57, zi48, {zi48, zi57}, zi56, zll_main_putreg11_out);
  assign zi58 = zll_main_putreg11_out;
  Main_incrPC  instR24 (zi58, main_incrpc_outR1);
  ZLL_Main_loop226  instR25 (main_incrpc_outR1, zll_main_loop226_outR4);
  assign zi59 = zll_main_loop226_outR4;
  assign zi60 = zi59[69:0];
  Main_getPC  instR26 (zi60, main_getpc_outR1);
  ZLL_Main_reset44  instR27 (main_getpc_outR1, zll_main_reset44_outR1);
  ZLL_Main_loop226  instR28 (zll_main_reset44_outR1, zll_main_loop226_outR5);
  assign zi61 = zll_main_loop226_outR5;
  assign zi62 = zi61[69:0];
  Main_getOut  instR29 (zi62, main_getout_outR4);
  ZLL_Main_loop142  instR30 (main_getout_outR4, zll_main_loop142_outR3);
  assign zi63 = zll_main_loop142_outR3;
  ...
  ZLL_Main_loop226  instR34 ((zi70 == 1'h1) ? main_incrpc_outR2 : main_putpc1_out, zll_main_loop226_outR6);
  assign zi72 = zll_main_loop226_outR6;
  assign zi73 = zi72[69:0];
  Main_getPC  instR35 (zi73, main_getpc_outR2);
  ZLL_Main_reset44  instR36 (main_getpc_outR2, zll_main_reset44_outR2);
  ZLL_Main_loop226  instR37 (zll_main_reset44_outR2, zll_main_loop226_outR7);
  assign zi74 = zll_main_loop226_outR7;
  assign zi75 = zi74[69:0];
  Main_getOut  instR38 (zi75, main_getout_outR5);
  ZLL_Main_loop142  instR39 (main_getout_outR5, zll_main_loop142_outR4);
  assign zi76 = zll_main_loop142_outR4;
  assign zi77 = zi76[84:70];
  assign zi78 = zi76[69:0];
  assign res = (zi9[78:76] == 3'h0) ? {{1'h1, {6'h35{1'h0}}}, zi23, 4'h5, zi24} : ((zi9[78:76] == 3'h1) ? {{1'h1, {6'h35{1'h0}}}, zi29, 4'h8, zi30} : ((zi9[78:76] == 3'h2) ? {{1'h1, {6'h35{1'h0}}}, zi46, 4'h1, zi47} : ((zi9[78:76] == 3'h3) ? {{1'h1, {6'h35{1'h0}}}, zi64, 4'h4, zi65} : {{1'h1, {6'h35{1'h0}}}, zi77, 4'h2, zi78})));
endmodule
...
module ZLL_Main_getReg23 (input logic [1:0] arg0,
  ...
  logic [16:0] zi18;
  logic [14:0] zi19;
  logic [7:0] zll_main_r11_outR1;
  logic [7:0] zi25;
  logic [7:0] zi26;
  logic [5:0] zi27;
  logic [16:0] zi28;
  logic [14:0] zi29;
  logic [7:0] zll_main_r12_out;
  logic [7:0] zi36;
  logic [5:0] zi37;
  logic [16:0] zi38;
  logic [14:0] zi39;
  ...
  ZLL_Main_r11  inst (zi3, zi5, zi6, zi7, zi8, zi9, zll_main_r11_out);
  ...
  ZLL_Main_r11  instR1 (zi14, zi15, zi16, zi17, zi18, zi19, zll_main_r11_outR1);
  assign zi25 = arg2[53:46];
  assign zi26 = arg2[45:38];
  assign zi27 = arg2[37:32];
  assign zi28 = arg2[31:15];
  assign zi29 = arg2[14:0];
  ZLL_Main_r12  instR2 (zi25, zi26, zi27, zi28, zi29, zll_main_r12_out);
  assign zi36 = arg2[45:38];
  assign zi37 = arg2[37:32];
  assign zi38 = arg2[31:15];
  assign zi39 = arg2[14:0];
  ZLL_Main_r17  instR3 (zi36, zi37, zi38, zi39, zll_main_r17_out);
  assign res = (arg1 == 2'h0) ? {zll_main_r11_out, arg2} : ((arg0 == 2'h1) ? {zll_main_r11_outR1, arg2} : ((arg0 == 2'h2) ? {zll_main_r12_out, arg2} : {zll_main_r17_out, arg2}));
endmodule

module ZLL_Main_putReg58 (input logic [7:0] arg0,
  ...
  output logic [69:0] res);
  assign res = {arg2, arg3, arg0, arg1, arg4, arg5, arg6};
endmodule
...
module ZLL_Main_loop143 (input logic [69:0] arg0,
  output logic [69:0] res);
  logic [69:0] zll_main_putweout5_out;
...
module ZLL_Main_loop142 (input logic [84:0] arg0,
  output logic [142:0] res);
  logic [14:0] zi0;
  logic [69:0] zi1;
...
module ZLL_Main_r12 (input logic [7:0] arg0,
  input logic [7:0] arg1,
  ...
  output logic [7:0] res);
  logic [7:0] zll_main_r17_out;
  ZLL_Main_r17  inst (arg0, arg2, arg3, arg4, zll_main_r17_out);
  assign res = zll_main_r17_out;
endmodule
...
module ZLL_Main_r11 (input logic [7:0] arg0,
  input logic [7:0] arg1,
  input logic [7:0] arg2,
  ...
  output logic [7:0] res);
  logic [7:0] zll_main_r12_out;
  ZLL_Main_r12  inst (arg0, arg2, arg3, arg4, arg5, zll_main_r12_out);
  assign res = zll_main_r12_out;
endmodule
...
module ZLL_Main_putReg11 (input logic [7:0] arg0,
  input logic [1:0] arg1,
  ...
  logic [16:0] zi21;
  logic [14:0] zi22;
  logic [69:0] zll_main_putreg58_out;
  logic [7:0] zi28;
  logic [7:0] zi29;
  logic [7:0] zi31;
  logic [5:0] zi32;
  ...
  logic [16:0] zi45;
  logic [14:0] zi46;
  logic [69:0] zll_main_putreg58_outR1;
  assign zi0 = arg2[7:0];
  ...
  ZLL_Main_putReg58  inst (zi18, zi19, zi16, arg0, zi20, zi21, zi22, zll_main_putreg58_out);
  ...
  ZLL_Main_putReg58  instR1 (zi42, arg0, zi40, zi41, zi44, zi45, zi46, zll_main_putreg58_outR1);
  assign res = (arg2[9:8] == 2'h0) ? {zi0, zi5, zi6, zi7, zi8, zi9, zi10} : ((arg1 == 2'h1) ? zll_main_putreg58_out : ((arg1 == 2'h2) ? {zi28, zi29, arg0, zi31, zi32, zi33, zi34} : zll_main_putreg58_outR1));
endmodule
