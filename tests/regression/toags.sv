module top_level (input logic [0:0] clk,
  ...
  logic [0:0] zi1;
  logic [6:0] zll_main_go33_out;
  logic [0:0] zi4;
  logic [6:0] zll_main_go33_outR1;
  logic [6:0] zres;
  assign zi1 = __resumption_tag[0];
  ZLL_Main_go33  inst (zi1, __in0, __st0, __st1, zll_main_go33_out);
  assign zi4 = __resumption_tag[0];
  ZLL_Main_go33  instR1 (__in0, __st0, __st0, __st1, zll_main_go33_outR1);
  assign zres = (__resumption_tag[2:1] == 2'h1) ? zll_main_go33_out : ((__resumption_tag[2:1] == 2'h2) ? {5'h10, __st0, zi4} : ((__in0 == 1'h1) ? {4'h9, __in0, __st0, __st1} : zll_main_go33_outR1));
...
module ZLL_Main_go33 (input logic [0:0] arg0,
