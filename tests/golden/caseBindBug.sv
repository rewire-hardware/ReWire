module top_level (input logic [0:0] clk,
  ...
  assign zi5 = zi4[1];
  assign zi6 = zi4[0];
  ZLL_Main_go4  inst (zi5, zi6, zll_main_go4_out);
  ZLL_Main_go4  instR1 (__st0, __st0, zll_main_go4_outR1);
  assign zres = (__in0 == 1'h1) ? zll_main_go4_out : zll_main_go4_outR1;
