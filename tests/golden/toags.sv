module top_level (input logic [0:0] clk,
  ...
  assign zres = (__resumption_tag[2:1] == 2'h1) ? {4'h4, __st0, zi1} : ((__resumption_tag[2:1] == 2'h2) ? ((__in0 == 1'h0) ? zll_main_go8_out : {3'h0, __in0, __st0, __st1}) : zll_main_go8_outR1);
...
module ZLL_Main_go8 (input logic [0:0] arg0,
  ...
  ZLL_Main_go2  inst (arg0, arg0, zll_main_go2_out);
  ZLL_Main_go2  instR1 ((arg1 == 1'h0) ? zll_main_go2_out : arg0, arg1, zll_main_go2_outR1);
  assign res = {zll_main_go2_outR1, 2'h1, arg1, arg2, arg3};
endmodule
