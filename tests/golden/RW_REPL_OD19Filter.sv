module top_level (input logic [0:0] clk,
  ...
  logic [38:0] zi0;
  logic [40:0] main_$l_main_putreg19$372_out;
  logic [40:0] main_$l_main_getreg24$379_out;
  logic [40:0] main_$l_main_putreg19$372_outR1;
  logic [40:0] main_$l_main_getreg24$379_outR1;
  logic [0:0] extres;
  logic [0:0] zi5;
  logic [1:0] zi6;
  logic [0:0] extresR1;
  ...
  logic [0:0] zi11;
  logic [1:0] zi12;
  logic [40:0] main_$l_main_nextpc9$359_out;
  logic [40:0] zres;
  assign zi0 = {__st0, __st1};
  main_$L_Main_putReg19$372  inst (__in1, zi0, main_$l_main_putreg19$372_out);
  main_$L_Main_getReg24$379  instR1 (__in1, zi0, main_$l_main_getreg24$379_out);
  main_$L_Main_putReg19$372  instR2 (__in1, zi0, main_$l_main_putreg19$372_outR1);
  main_$L_Main_getReg24$379  instR3 (__in1, zi0, main_$l_main_getreg24$379_outR1);
  test2  instR4 (__in1, __st0, extres[0]);
  assign zi5 = extres;
  assign zi6 = {1'h0, zi5};
  test3  instR5 (__in1, __st0, extresR1[0]);
  assign zi8 = extresR1;
  assign zi9 = {1'h0, zi8};
  test4  instR6 (__in1, __st0, extresR2[0]);
  assign zi11 = extresR2;
  assign zi12 = {1'h0, zi11};
  main_$L_Main_nextPC9$359  instR7 (zi0, main_$l_main_nextpc9$359_out);
  assign zres = (__in0 == 1'h0) ? ((__st1 == 7'h0) ? main_$l_main_putreg19$372_out : ((__st1 == 7'h1) ? main_$l_main_getreg24$379_out : ((__st1 == 7'h2) ? main_$l_main_putreg19$372_outR1 : ((__st1 == 7'h3) ? main_$l_main_getreg24$379_outR1 : ((__st1 == 7'h4) ? {zi6, zi0} : ((__st1 == 7'h5) ? {zi9, zi0} : ((__st1 == 7'h6) ? {zi12, zi0} : main_$l_main_nextpc9$359_out))))))) : {2'h2, zi0};
...
module main_$L_Main_nextPC9$359 (input logic [38:0] arg0,
...
module main_$L_Main_putReg19$372 (input logic [31:0] arg0,
  ...
  assign zi1 = arg1[6:0];
  assign zi2 = {arg0, zi1};
  main_$L_Main_nextPC9$359  inst (zi2, main_$l_main_nextpc9$359_out);
  assign res = main_$l_main_nextpc9$359_out;
endmodule

module main_$L_Main_getReg24$379 (input logic [31:0] arg0,
  input logic [38:0] arg1,
  output logic [40:0] res);
  logic [31:0] zi0;
  logic [0:0] extres;
