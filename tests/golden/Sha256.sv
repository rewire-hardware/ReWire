module top_level (input logic [0:0] clk,
  ...
  main_loop  inst (zi2, zi3, zi4, __st6, main_loop_out);
  ...
  main_dev  instR1 (__in0, zi2, zi3, zi23, __st6, main_dev_out);
  assign zi24 = {__st0, __st1};
  assign zi25 = {__st2, __st3};
  assign zi26 = {__st4, __st5};
  main_loop  instR2 (zi24, zi25, zi26, __st6, main_loop_outR1);
  assign zi28 = {__st0, __st1};
  assign zi29 = {__st2, __st3};
  assign zi30 = {__st4, __st5};
  main_dev  instR3 (__in0, zi28, zi29, zi30, __st6, main_dev_outR1);
  assign zres = (__resumption_tag[7:6] == 2'h0) ? ((~zi6) ? main_loop_out : main_dev_out) : ((__resumption_tag[7:6] == 2'h1) ? main_loop_outR1 : main_dev_outR1);
...
module main___unused7 (input logic [511:0] arg0,
...
module main_dev (input logic [513:0] arg0,
  ...
  main___unused7  inst (hw32, 256'h6a09e667bb67ae853c6ef372a54ff53a510e527f9b05688c1f83d9ab5be0cd19, arg2, 256'h6a09e667bb67ae853c6ef372a54ff53a510e527f9b05688c1f83d9ab5be0cd19, 6'h0, main__unused7_out);
  assign hw32R1 = arg0[511:0];
  main___unused7  instR1 (hw32R1, arg3, arg2, arg3, 6'h0, main__unused7_outR1);
  assign zi0 = {2'h0, arg3};
  assign res = (arg0[513:512] == 2'h0) ? main__unused7_out : ((arg0[513:512] == 2'h1) ? main__unused7_outR1 : {zi0, 8'h80, arg1, arg2, arg3, arg4});
endmodule