module top_level (input logic [0:0] clk,
  ...
  ZLL_Main_sig3  inst (__st0, __st1, zll_main_sig3_out);
  assign zi4 = __st0 ^ __st1;
  ZLL_Main_sig3  instR1 (__st1, zi4, zll_main_sig3_outR1);
  assign zres = (zi3 == 1'h0) ? zll_main_sig3_out : zll_main_sig3_outR1;
