module top_level (input logic [0:0] clk,
  ...
  assign zi1 = (zi0 == 1'h1) ? 1'h1 : 1'h0;
  Main_zookus  inst (zi1, main_zookus_out);
  assign zi2 = main_zookus_out;
  Main_zookus  instR1 (zi2, main_zookus_outR1);
  assign zi3 = main_zookus_outR1;
  assign zres = (__resumption_tag[1] == 1'h0) ? {zi3, 1'h0, zi1} : 3'h0;
