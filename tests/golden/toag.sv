module top_level (input logic [0:0] clk,
  ...
  assign zi1 = zi0 ? zi0 : 1'h0;
  assign zi2 = (~__in0) ? zi1 : zi0;
  assign zi3 = zi2 ? __in0 : 1'h0;
  assign zres = (__resumption_tag[2:1] == 2'h0) ? 4'h4 : ((__resumption_tag[2:1] == 2'h1) ? {zi3, 3'h0} : ((~__in0) ? {__in0, 2'h1, __in0} : {3'h1, __in0}));
