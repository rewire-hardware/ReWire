module top_level (input logic [0:0] clk,
  ...
  ZLL_Main_go6  inst (zi0, zi0, zll_main_go6_out);
  ZLL_Main_go6  instR1 (__in0, (__in0 == 1'h0) ? zll_main_go6_out : zi0, zll_main_go6_outR1);
  assign zres = (__resumption_tag[2:1] == 2'h1) ? {zll_main_go6_outR1, 3'h4} : ((__resumption_tag[2:1] == 2'h2) ? 4'h0 : ((__in0 == 1'h0) ? {__in0, 2'h1, __in0} : {3'h1, __in0}));
