...
\vspace{1em}
\infer[\textsc{T-RunS}]{\Gamma\vdash{}\textbf{run}_{\mathbb{S},t,t',M} : \mathbb{S}_tM(t') \rightarrow t \rightarrow M(t'\times{}t)}{}
\vspace{1em}
\infer[\textsc{T-RunE}]{\Gamma\vdash{}\textbf{run}_{\mathbb{E},t,t',M} : \mathbb{E}_tM(t') \rightarrow M(t'+t)}{}
\vspace{1em}
\infer[\textsc{T-RunM}]{\Gamma\vdash{}\textbf{run}_{\mathbb{M},t,t',t'',M} : \mathbb{M}_{t:t'}M(t'') \rightarrow t' \rightarrow M(t'')}{}
\vspace{1em}
\infer[\textsc{T-Extrude}]{\Gamma\vdash{}\textbf{extrude}_{T,M,t,t',t''} : \mathbb{R}_{t:t'}TM(t'') \rightarrow T\mathbb{R}_{t:t'}M(t'')}{}
